...
bitonic_merge_sixteen_zmm(zmm_t *zmm)
{
    ...
    zmm[0] = bitonic_merge_zmm<vtype>(zmm_t01);
    zmm[1] = bitonic_merge_zmm<vtype>(zmm_t02);
    zmm[2] = bitonic_merge_zmm<vtype>(zmm_t03);
    zmm[3] = bitonic_merge_zmm<vtype>(zmm_t04);
    zmm[4] = bitonic_merge_zmm<vtype>(zmm_t05);
    zmm[5] = bitonic_merge_zmm<vtype>(zmm_t06);
    zmm[6] = bitonic_merge_zmm<vtype>(zmm_t07);
    zmm[7] = bitonic_merge_zmm<vtype>(zmm_t08);
    zmm[8] = bitonic_merge_zmm<vtype>(zmm_t09);
